...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-[#111] text-gray-500 py-12 px-4 md:px-12 max-w-6xl mx-auto mt-20">
      ...
      <button className="mt-8 border border-gray-600 px-2 py-1 text-xs hover:text-white transition-colors">
        Service Code
      </button>

      <div className="mt-8 text-[10px] md:text-xs">
